...
# 
# In the file I add the logic iaddq (IIADDQ) in the same sort of manner
# as I did in seq-full file. It follows the same stages. The only difference
# seen in between is that of the differnt registers i.e rB vs D_rB
#
# Stage:			
#		iaddq V, rB
# Fetch: 
...
bool set_cc = (E_icode == IOPQ || E_icode == IIADDQ) && #this maybe
